...
public class Ejemplo extends JFrame implements ActionListener {
	...
	public Ejemplo() {
		...
		JButton btnAgreagar = new JButton("Agregar");
		btnAgreagar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				actionPerformedBtnAgreagar(e);
			}
		});
		btnAgreagar.setBounds(10, 11, 89, 23);
		contentPane.add(btnAgreagar);
	}
	...
	protected void actionPerformedBtnAgreagar(ActionEvent e) {
