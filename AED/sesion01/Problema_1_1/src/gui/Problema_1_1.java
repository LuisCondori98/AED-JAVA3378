...
public class Problema_1_1 extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnProcesar(ActionEvent arg0) {
		...
		imprimir("Descuento \t: " + String.format("%,8.2f", doc.calcularDescuento()));
		imprimir("Sueldo Neto \t: " + String.format("%,8.2f", doc.calcularSueldoNeto()));
		imprimir("Sueldo Bruto \t: " + String.format("%,8.2f", doc.retornarSueldoBruto()));
	}
